...
```bash
yarn add --dev @iconify-icons/heroicons-solid
```
...
import libraryIcon from '@iconify-icons/heroicons-solid/library';
...
import receiptRefund from '@iconify-icons/heroicons-solid/receipt-refund';
...
```svelte
<script>
    // npm install --save-dev @iconify/svelte @iconify-icons/heroicons-solid
